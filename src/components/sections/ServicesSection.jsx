    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-14 max-w-2xl">
          ...
          <p className="text-base text-navy/90 leading-relaxed max-w-lg">
            ...
            return (
              ...
              >
                ...
                <div className="p-5 sm:p-7 md:p-8 flex flex-col flex-1 relative z-10">
                  ...
                  <p className="text-base text-navy/95 leading-[1.85] mb-7">
                    {service.description}
                  </p>
                    ...
                    <div className="mb-6 bg-navy/4 border border-navy/8 rounded-xl p-4">
                      ...
                      <ul className="space-y-2.5">
                        {service.partnerWith.map((item, idx) => (
                          <li key={idx} className="flex items-start gap-3 text-sm text-navy/90 leading-relaxed">
                  ...
                  {service.features && service.features.length > 0 && (
                    <>
                      ...
                      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-navy/75 mb-4">
                      ...
                      <ul className="space-y-3.5 mb-7" role="list">
                        {service.features.map((feature, idx) => (
                          <li key={idx} className="flex items-start gap-4">
                            ...
                            <span className="text-sm text-navy/90 leading-relaxed">{feature}</span>
                          </li>
                        ))}
                      </ul>
                    </>
                  ...
                  {service.suitedFor && service.suitedFor.length > 0 && (
                    <div className="mb-6">
                      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-navy/75 mb-2.5">
                        Especially suited for institutions that value:
                      </p>
                      <div className="flex gap-3 flex-wrap">
                        {service.suitedFor.map((s, idx) => (
                          <span key={idx} className="flex items-center gap-2 text-sm text-navy/90">
                  ...
                  {service.note && (
                    <>
                      ...
                      <p className="font-display italic font-light text-xs text-navy/75 leading-relaxed mb-6">
                        {service.note}
                      </p>
                    </>
                  )}
